...
exports.seed = function(knex) {
  ...
  return knex('users').del()
    .then(function () {
      ...
      knex('anna').insert([
        {id: 1, eventTitle: 'Lunch', startDate: '2021-07-05', startTime: '1200', endDate:'2021-07-05', endTime:'1300', type: 'event', location: 'office', availability: 'free', attendees: {Mello:'true', Briana:'true'}},
        {id: 2, eventTitle: 'Break', startDate: '2021-07-07', startTime: '1400', endDate:'2021-07-07', endTime:'1430', type: 'event', location: 'office', availability: 'free', attendees: {Felix:'true', Mello:'true'}},
        {id: 3, eventTitle: 'Meeting', startDate: '2021-07-10', startTime: '1630', endDate:'2027-07-10', endTime:'1700', type: 'event', location: 'office', availability: 'busy', attendees: {Felix: 'true', Briana:'true'}},
